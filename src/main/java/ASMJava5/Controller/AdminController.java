...
//		ACCOUNT----------------------------------------------------------------
	...
	public String createAccount(Model model, @RequestParam("UserName") String UserName,
			@RequestParam("Password") String Password, @RequestParam("Role") Boolean Role,
			@RequestParam("Activated") Boolean Activated, @RequestParam("Image") String Image,
			@RequestParam("Name") String Name, @RequestParam("email") String Email,
			@RequestParam("Address") String Address, @RequestParam("Phone") String Phone,
			@RequestParam("ZipCode") String ZipCode, @RequestParam("Intimately") String Intimately) {
		User user = new User();
...
//			System.out.println(productOptional);
	...
	public String updateAccount(Model model, @RequestParam("UserName") String UserName,
			@RequestParam("Password") String Password, @RequestParam("Role") Boolean Role,
			@RequestParam("Activated") Boolean Activated, @RequestParam("Image") String Image,
			@RequestParam("Name") String Name, @RequestParam("email") String Email,
			@RequestParam("Address") String Address, @RequestParam("Phone") String Phone,
...
//			System.out.println(productOptional);
	...
	public String update(Model model, @RequestParam("productid") String productid, @RequestParam("name") String name,
			@RequestParam("image") String image, @RequestParam("Category") String category,
			@RequestParam("price") Double price, @RequestParam("available") Boolean available,
			@RequestParam("decription") String decription) {
		try {
